...
2. **Using the DAPP**
   ...
   -  **Important:Everytime you change the metamask account check if it got connected to the network on your extensions->metamask before doing any function in the DAPP.**
   - **ADMIN**
